 ...
 * @version : $Id: index.php 0000 31/03/2009 20:45:21:000 Catzwolf $
 */
include 'header.php';
...
switch ( $op ) {
    ...
    case 'refer':
        ...
        $xoopsTpl->assign( 'refer',
            array( 'title' => $refer_obj->getVar( 'wfcr_title' ),
    ...
    case 'link':
        ...
        $xoopsTpl->assign( 'linktous',
            array( 'textlink' => $link_obj->getTextLink( 'wfcl_textlink' ),
        ...
        switch ( $act ) {
            ...
            default:
                ...
                $xoopsTpl->assign( 'page_info',
                    array( 'id' => $pageObj->getVar( 'wfc_cid' ),
                        'title' => $pageObj->getTitle(),
                        'counter' => sprintf( _MD_WFP_COUNTER, $pageObj->getVar( 'wfc_counter' ) ),
