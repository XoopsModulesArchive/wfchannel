 ...
 * @version : $Id: refers.php 0000 24/03/2009 23:30:47:000 Catzwolf $
 */
 ...
 */
$menu_handler->addHeader( _MA_WFC_REFERSAREA );
...
switch ( $op ) {
	...
	default:
		...
		$tlist->addFooter( array( 'deleteall' => _MA_WFC_DELETESELECTED ) );
		$tlist->setPath( 'op=' . $op );
		...
		// HTML output
		xoops_cp_header();
		$menu_handler->addSubHeader( _MA_WFC_REFERSAREA_DSC );
