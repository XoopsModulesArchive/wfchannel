 ...
 * @version : $Id: form_wfc_page.php 0000 14/03/2009 12:45:47:000 Catzwolf $
 */
defined( 'XOOPS_ROOT_PATH' ) or die( 'Restricted access' );

if ( !$this->isNew() ) {
    echo '<div style="padding: 5px; float: left;"><a target="_BLANK" href="../index.php?wfc_cid=' . $this->getVar( 'wfc_cid' ) . '">' . _MA_WFC_QUICKVIEW . '</a></div>';
}
...
$options_tray = new XoopsFormElementTray( _MA_EWFC_PAGE_CONTENT . ': ' . $this->getVar( 'wfc_title' ), '<br />' );
