...
$form = new XoopsThemeTabForm( _MA_WFC_CMODIFYREFER, 'op', 'refer.php' );
...
# * Refer Title
# */
$wfcr_title = new XoopsFormText( _MA_EWFC_REFER_TITLE, 'wfcr_title', 50, 255, $this->getVar( 'wfcr_title', 'e' ) );
$wfcr_title->setDescription( _MA_EWFC_REFER_TITLE_DSC );
$form->addElement( $wfcr_title, true );
#
#/**
# * Refer Content
# */
$options_tray = new XoopsFormElementTray( _MA_EWFC_REFER_INTRO, '<br />' );
 ...
 */
$wfcr_mainpage = new XoopsFormRadioYN( _MA_EWFC_REFER_MENU, 'wfcr_mainpage', $this->getVar( 'wfcr_mainpage' ), ' ' . _MA_WFP_YES . '', ' ' . _MA_WFP_NO . '' );
$wfcr_mainpage->setDescription( _MA_EWFC_REFER_MENU_DSC );
 ...
 * Refer Main Page item
 */
$wfcr_email = new XoopsFormRadioYN( _MA_EWFC_REFER_EMAIL, 'wfcr_email', $this->getVar( 'wfcr_email' ), ' ' . _MA_WFP_YES . '', ' ' . _MA_WFP_NO . '' );
$wfcr_email->setDescription( _MA_EWFC_REFER_EMAIL_DSC );
$form->addElement( $wfcr_email, false );

/**
 * Refer Main Page item
 */
$wfcr_dblurb = new XoopsFormTextArea( _MA_EWFC_REFER_DEFBLURB, 'wfcr_dblurb', $this->getVar( 'wfcr_dblurb' ), 15, 70 );
$wfcr_dblurb->setDescription( _MA_EWFC_REFER_DEFBLURB_DSC );
$form->addElement( $wfcr_dblurb, false );

/**
 * Refer Main Page item
 */
$wfcr_ublurb = new XoopsFormRadioYN( _MA_EWFC_REFER_USERBLURB, 'wfcr_ublurb', $this->getVar( 'wfcr_ublurb' ), ' ' . _MA_WFP_YES . '', ' ' . _MA_WFP_NO . '' );
$wfcr_ublurb->setDescription( _MA_EWFC_REFER_USERBLURB_DSC );
 ...
 * Page Image
 */
$wfcr_image = new XoopsFormSelectImage( _MA_EWFC_PAGE_LOGO, 'wfcr_image', $this->getVar( 'wfcr_image', 'e' ), 'xoops_image', 0, $size = 5 );
$wfcr_image->setDescription( _MA_EWFC_PAGE_LOGO_DSC );
$wfcr_image->setCategory( wfp_getModuleOption( 'uploaddir' ) );
$form->addElement( $wfcr_image, false );

$image = $this->getImageEdit( 'wfcr_image' );

$wfcr_imgwidth = new XoopsFormText( _MA_EWFC_MENU_IMGWIDTH, 'imgwidth', 5, 5, $image['width'] );
$wfcr_imgwidth->setDescription( _MA_EWFC_MENU_IMGWIDTH_DSC );
$form->addElement( $wfcr_imgwidth, false );

$wfcr_imgheight = new XoopsFormText( _MA_EWFC_MENU_IMGHEIGHT, 'imgheight', 5, 5, $image['height'] );
$wfcr_imgheight->setDescription( _MA_EWFC_MENU_IMGHEIGHT_DSC );
$form->addElement( $wfcr_imgheight, false );

$wfcr_caption = new XoopsFormText( _MA_EWFC_MENU_CAPTION, 'wfcr_caption', 50, 150, $this->getVar( 'wfcr_caption', 'e' ) );
$wfcr_caption->setDescription( _MA_EWFC_MENU_CAPTION_DSC );
...
/**
 */
$wfcr_privacy = new XoopsFormRadioYN( _MA_EWFC_REFER_PDISPLAY, 'wfcr_privacy', $this->getVar( 'wfcr_privacy' ), ' ' . _MA_WFP_YES . '', ' ' . _MA_WFP_NO . '' );
$wfcr_privacy->setDescription( _MA_EWFC_REFER_PDISPLAY_DSC );
$form->addElement( $wfcr_privacy, false );
/**
 */
$wfcr_privacytext = new XoopsFormTextArea( _MA_EWFC_REFER_PSTATEMENT, 'wfcr_privacytext', $this->getVar( 'wfcr_privacytext', 'e' ), 5, 60 );
$wfcr_privacytext->setDescription( _MA_EWFC_REFER_PSTATEMENT_DSC );
...
$groups = new XoopsFormSelectCheckGroup( _MA_EWFP_GROUPS, 'refer_read', $group->getAdmin( $this->getVar( 'wfcr_id' ) ), '', true );
