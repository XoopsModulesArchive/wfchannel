<?php
/**
 * $Id: modinfo.php,v 1.1 2004/01/12 15:40:57 catzwolf Exp $
 * Module: WF-Channel
 * Version: v1.0.2
...
define( '_MA_WFC_ADMENU1', 'Channel Administration' );
...
define( '_MA_WFC_BANNEDDSC', 'The IP address will not be allowed to use the refer section of this module.<br /><br />Please separate each one with |.' );
...
define( '_MA_WFC_MENULINKSDSC', 'Selects how to display the menu links within the page: <br /><br />None: Do not display menu links<br />Both: Display both top and menu links on the page.<br />Top: Only display the menu at the top of the page.<br />Bottom: Only display the menu at the bottom of the page.' );
...
define( '_MA_WFC_ALLOWADMIN', 'Allow Administration Hits?' );
define( '_MA_WFC_ALLOWADMIN_DSC', 'Enable to allow administrator page hits to count towards the page hit count.' );
...
define( '_MA_WFC_XOOPSTAGS_DSC', 'Enable Xoops Tags module (XoopsTag by DJ) integration.' );
