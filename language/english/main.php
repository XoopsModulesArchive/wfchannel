...
define( '_MD_WFC_CAPTACHA', 'Please enter the letters in the image as you see them.' );
define( '_MD_WFC_CAPTACHA_ERROR', 'Please enter the letters in the image as you see them.' );
define( '_MD_WFC_ERRORS', 'WFChannel Errors.' );
define( '_MD_WFC_CAPTACHA_ERRORSEND', 'The captcha you entered did not match the one that we have stored. Please go back and try again' );
 ...
 * quick fix
 */
//if ( !defined( '_MD_WFP_ADMINTASKS' ) ) {
//	define( '_MD_WFP_ADMINTASKS', 'Admin Task: ' );
//}
